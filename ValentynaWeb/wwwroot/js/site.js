...
const translations = {
  ua: {
    ...
    'free': 'БЕЗКОШТОВНО',
    // Прайс з Bloom CRM (services.json, translateKey svc-*)
    'svc-group-scissors': 'Стрижки ножицями',
    'svc-length-1': '1 довжина',
    'svc-length-2': '2 довжина',
    'svc-length-3': '3 довжина',
    'svc-length-4': '4 довжина',
    'svc-bangs': 'Чубчик',
    'svc-kids-scissors': 'Дитяча стрижка ножицями',
    'svc-donation': 'Стрижка донат на лікування раку',
    'svc-group-clipper': 'Стрижки з машинкою/чоловічі стрижки',
    'svc-clipper-one': 'Машинка під одну насадку',
    'svc-men-short': 'Чоловіча/Коротка стрижка з машинкою',
    'svc-beard': 'Борода',
    'svc-men-beard': 'Чоловіча + борода',
    'svc-kids-clipper': 'Дитяча стрижка з машинкою',
    'svc-group-wash': 'Миття голови',
    'svc-length-1-2': '1/2 довжина',
    'svc-length-3-4': '3/4 довжина',
    'svc-length-5': '5/5+ довжина',
    'svc-group-k18': 'Догляд К18',
    'svc-group-oil': 'Догляд La Biosthetique Oil therapy',
    'svc-group-voey': 'Пілінг Voey Flake Escape',
  ...
  en: {
    ...
    'free': 'FREE',
    // Price list from Bloom CRM (services.json, translateKey svc-*)
    'svc-group-scissors': 'Scissor haircuts',
    'svc-length-1': 'Length 1',
    'svc-length-2': 'Length 2',
    'svc-length-3': 'Length 3',
    'svc-length-4': 'Length 4',
    'svc-bangs': 'Bangs',
    'svc-kids-scissors': 'Kids\' scissor haircut',
    'svc-donation': 'Charity haircut (donation for cancer treatment)',
    'svc-group-clipper': 'Clipper & men\'s haircuts',
    'svc-clipper-one': 'Clipper cut, one guard',
    'svc-men-short': 'Men\'s / short clipper haircut',
    'svc-beard': 'Beard',
    'svc-men-beard': 'Men\'s haircut + beard',
    'svc-kids-clipper': 'Kids\' clipper haircut',
    'svc-group-wash': 'Hair wash',
    'svc-length-1-2': 'Length 1–2',
    'svc-length-3-4': 'Length 3–4',
    'svc-length-5': 'Length 5+',
    'svc-group-k18': 'K18 treatment',
    'svc-group-oil': 'La Biosthetique Oil therapy',
    'svc-group-voey': 'Voey Flake Escape scalp peeling',
